...
var $cid = $id('cid')
if(chain_id > 0){
    $cno($cid, 'cidtip').innerText = "Attention: The transactions generated by this wallet are specifically customized for test or fork chain with Chain ID = "+chain_id+" ("+chain_name+")"
